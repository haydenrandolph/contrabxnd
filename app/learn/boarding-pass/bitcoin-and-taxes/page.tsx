...
export default function BoardingPassLesson19() {
  const [menuOpen, setMenuOpen] = useState(false);
  const { isLightMode, toggleTheme } = useTheme();

  useEffect(() => {
    document.title = 'Bitcoin and Taxes | Contraband';
  }, []);
      ...
      <div className={`lesson-page ${isLightMode ? 'light-mode' : ''}`}>
        ...
        <header className="lesson-header">
          <div className="lesson-breadcrumb">
            ...
            <span className="breadcrumb-sep">→</span>
            <span className="breadcrumb-current">Lesson 19</span>
          </div>
          <div className="lesson-meta">
            <span className="lesson-number">Lesson 19 of 21</span>
            <span className="lesson-week">Week 3</span>
            <span className="lesson-duration">12 min read</span>
          </div>
          <h1 className="lesson-title">Bitcoin and Taxes</h1>
          <p className="lesson-subtitle">What you need to know (but ask a professional).</p>
        </header>
        ...
        <nav className="lesson-navigation">
          <Link href="/learn/boarding-pass/shitcoins-why-bitcoin-only" className="nav-btn">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M19 12H5M12 19l-7-7 7-7"/>
            </svg>
            Lesson 18
          </Link>
          <Link href="/learn/boarding-pass/the-road-to-self-custody" className="nav-btn primary">
            Lesson 20
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
