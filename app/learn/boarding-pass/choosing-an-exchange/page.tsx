...
export default function BoardingPassLesson09() {
  const [menuOpen, setMenuOpen] = useState(false);
  const { isLightMode, toggleTheme } = useTheme();

  useEffect(() => {
    document.title = 'Choosing an Exchange | Contraband';
  }, []);
      ...
      <div className={`lesson-page ${isLightMode ? 'light-mode' : ''}`}>
        ...
        <header className="lesson-header">
          <div className="lesson-breadcrumb">
            ...
            <span className="breadcrumb-sep">→</span>
            <span className="breadcrumb-current">Lesson 9</span>
          </div>
          <div className="lesson-meta">
            <span className="lesson-number">Lesson 09 of 21</span>
            <span className="lesson-week">Week 2</span>
            <span className="lesson-duration">12 min read</span>
          </div>
          <h1 className="lesson-title">Choosing an Exchange</h1>
          <p className="lesson-subtitle">What to look for and what to avoid.</p>
        </header>
        ...
        <nav className="lesson-navigation">
          <Link href="/learn/boarding-pass/ways-to-acquire-bitcoin" className="nav-btn">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M19 12H5M12 19l-7-7 7-7"/>
            </svg>
            Lesson 8
          </Link>
          <Link href="/learn/boarding-pass/your-first-purchase" className="nav-btn primary">
            Lesson 10
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
