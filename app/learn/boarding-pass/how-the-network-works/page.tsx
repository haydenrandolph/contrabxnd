...
export default function BoardingPassLesson04() {
  const [menuOpen, setMenuOpen] = useState(false);
  const { isLightMode, toggleTheme } = useTheme();

  useEffect(() => {
    document.title = 'How the Network Works | Contraband';
  }, []);
      ...
      <div className={`lesson-page ${isLightMode ? 'light-mode' : ''}`}>
        ...
        <header className="lesson-header">
          <div className="lesson-breadcrumb">
            ...
            <span className="breadcrumb-sep">→</span>
            <span className="breadcrumb-current">Lesson 4</span>
          </div>
          <div className="lesson-meta">
            <span className="lesson-number">Lesson 04 of 21</span>
            <span className="lesson-week">Week 1</span>
            <span className="lesson-duration">18 min read</span>
          </div>
          <h1 className="lesson-title">How the Network Works</h1>
          <p className="lesson-subtitle">Nodes, miners, and the blockchain—demystified.</p>
        </header>
        ...
        <nav className="lesson-navigation">
          <Link href="/learn/boarding-pass/21-million-the-number-that-changes-everything" className="nav-btn">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M19 12H5M12 19l-7-7 7-7"/>
            </svg>
            Lesson 3
          </Link>
          <Link href="/learn/boarding-pass/bitcoin-vs-crypto" className="nav-btn primary">
            Lesson 5
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
