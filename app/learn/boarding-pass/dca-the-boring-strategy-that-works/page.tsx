...
export default function BoardingPassLesson15() {
  const [menuOpen, setMenuOpen] = useState(false);
  const { isLightMode, toggleTheme } = useTheme();

  useEffect(() => {
    document.title = 'DCA: The Boring Strategy That Works | Contraband';
  }, []);
      ...
      <div className={`lesson-page ${isLightMode ? 'light-mode' : ''}`}>
        ...
        <header className="lesson-header">
          <div className="lesson-breadcrumb">
            ...
            <span className="breadcrumb-sep">→</span>
            <span className="breadcrumb-current">Lesson 15</span>
          </div>
          <div className="lesson-meta">
            <span className="lesson-number">Lesson 15 of 21</span>
            <span className="lesson-week">Week 3</span>
            <span className="lesson-duration">12 min read</span>
          </div>
          <h1 className="lesson-title">DCA: The Boring Strategy That Works</h1>
          <p className="lesson-subtitle">Why time in the market beats timing the market.</p>
        </header>
        ...
        <nav className="lesson-navigation">
          <Link href="/learn/boarding-pass/the-seed-phrase-your-master-key" className="nav-btn">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M19 12H5M12 19l-7-7 7-7"/>
            </svg>
            Lesson 14
          </Link>
          <Link href="/learn/boarding-pass/volatility-feature-not-bug" className="nav-btn primary">
            Lesson 16
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
