...
export default function BoardingPassLesson08() {
  const [menuOpen, setMenuOpen] = useState(false);
  const { isLightMode, toggleTheme } = useTheme();

  useEffect(() => {
    document.title = 'Ways to Acquire Bitcoin | Contraband';
  }, []);
      ...
      <div className={`lesson-page ${isLightMode ? 'light-mode' : ''}`}>
        ...
        <header className="lesson-header">
          <div className="lesson-breadcrumb">
            ...
            <span className="breadcrumb-sep">→</span>
            <span className="breadcrumb-current">Lesson 8</span>
          </div>
          <div className="lesson-meta">
            <span className="lesson-number">Lesson 08 of 21</span>
            <span className="lesson-week">Week 2</span>
            <span className="lesson-duration">15 min read</span>
          </div>
          <h1 className="lesson-title">Ways to Acquire Bitcoin</h1>
          <p className="lesson-subtitle">Exchanges, P2P, earning, and more.</p>
        </header>
        ...
        <nav className="lesson-navigation">
          <Link href="/learn/boarding-pass/bitcoin-vs-crypto" className="nav-btn">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M19 12H5M12 19l-7-7 7-7"/>
            </svg>
            Lesson 7
          </Link>
          <Link href="/learn/boarding-pass/choosing-an-exchange" className="nav-btn primary">
            Lesson 9
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
