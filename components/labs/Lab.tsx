 ...
 * match the FML system; works in light and dark.
 */
export default function Lab({ title, note, children }: { title: string; note?: ReactNode; children: ReactNode }) {
  return (
    <>
      <style jsx global>{`
        .lab { border: 1px solid var(--cb-border); border-radius: var(--cb-radius); margin: 2rem 0; overflow: hidden; background: var(--cb-surface); }
